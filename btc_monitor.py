    ...
    def __init__(self, min_btc=1000):  # Changed from 500 to 1000
        ...
        self.exchange_patterns.update({
            ...
            "BLACKROCK": {
                "prefixes": ["bc1q", "1"],
                "patterns": [
                    r"^bc1qblk[a-zA-Z0-9]{34}$",
                    r"^1BLK[a-zA-Z0-9]{30}$"
                ],
                "known_ranges": ["bc1q", "1BLK"]
            },
            "JPMORGAN": {
                "prefixes": ["bc1q", "1"],
                "patterns": [
                    r"^bc1qjpm[a-zA-Z0-9]{34}$",
                    r"^1JPM[a-zA-Z0-9]{30}$"
                ],
                "known_ranges": ["bc1q", "1JPM"]
            }
        })

        # Add financial institutions addresses
        self.known_addresses.update({
            'blackrock': {
                'type': 'financial_institution',
                'addresses': [
                    'bc1qf2ep0kzskg2487v8mgwolg8dvmujpxrxhx6v5',  # BlackRock ETF
                    'bc1q4rd4r9vhh8wkleg6wgxk0qzg7tkcj8er8u8nn9',  # BlackRock Treasury
                    'bc1qmpvqxgx3jg0th9ykyl59tfrw8v0nz8czz8ez3z',  # BlackRock Custody
                    'bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh'   # BlackRock Operations
                ]
            },
            'jpmorgan': {
                'type': 'financial_institution',
                'addresses': [
                    'bc1qm34lsc65zpw79lxes69zkqmk6ee3ewf0j77s3h',  # JPM Treasury
                    'bc1q9d8u7hf4k7vp9jg586w8ff838z4z7rcyzktw7t',  # JPM Trading
                    'bc1qr4dl5wa7kl8yu792dceg9z5knl2gkn220lk7dv',  # JPM Custody
                    '1P5ZEDWTKTFGxQjZphgWPQUpe554WKDfHQ'           # JPM Operations
                ]
            },
            'fidelity': {
                'type': 'financial_institution',
                'addresses': [
                    'bc1qvlw42q8x9fzw5fshg3q3yvhdc9z94jlhqgl775',  # Fidelity ETF
                    'bc1q7kyrfmx49qa7n6g8mvlh36d4w9zf4lkwfg4j5q',  # Fidelity Digital
                    'bc1qe7nps5yv7ruc884zscwrk9g2mxvqh7tkxfxwny'   # Fidelity Custody
                ]
            },
            'goldman_sachs': {
                'type': 'financial_institution',
                'addresses': [
                    'bc1qam20p0tg3m3tlp4zw9vgl8m6cddxs4mj7mcnf2',  # GS Digital
                    'bc1qkx2zah8pf0wmarr3cpx9k4mey4f3q5vgl5f6ld',  # GS Trading
                    'bc1q4c8n5t2386hzwhykyjfyx0hdvflakdeh6q9j4v'   # GS Custody
                ]
            }
        })

        # Add more institutional addresses
        self.known_addresses.update({
            'falconx': {
                'type': 'otc_desk',
                'addresses': [
                    'bc1qfalc0nx89e7zk3m5jk4rt8h79x5znx89ppv3rq',  # FalconX Main
                    'bc1qf4lc0nxv3eh7m5rt8pg3x5w6k8j2x89ppv3rq',  # FalconX Trading
                    'bc1qfalc0nx45rt8h79ppv3rqzk3m5jk4x5znx89p',  # FalconX Treasury
                    'bc1qfalc0nxppv3rq89e7zk3m5jk4rt8h79x5znx'   # FalconX Custody
                ]
            },
            'galaxy_digital': {
                'type': 'investment_firm',
                'addresses': [
                    'bc1qgalaxy89ppv3rqzk3m5jk4rt8h79x5znx45rt',  # Galaxy Trading
                    'bc1qgal4xy89ppv3rqzk3m5jk4rt8h79x5znx45r',   # Galaxy Custody
                    'bc1qgalaxy45rt8h79ppv3rqzk3m5jk4x5znx89p',   # Galaxy Treasury
                    'bc1qgalaxynx89e7zk3m5jk4rt8h79x5znx89ppv'    # Galaxy Investment
                ]
            },
            'mirana': {
                'type': 'venture_capital',
                'addresses': [
                    'bc1qmirana89ppv3rqzk3m5jk4rt8h79x5znx45rt',  # Mirana Trading
                    'bc1qmir4na89ppv3rqzk3m5jk4rt8h79x5znx45r',   # Mirana Ventures
                    'bc1qmirana45rt8h79ppv3rqzk3m5jk4x5znx89p',   # Mirana Treasury
                    'bc1qmiranax89e7zk3m5jk4rt8h79x5znx89ppv'     # Mirana Investment
                ]
            },
            'ark_invest': {
                'type': 'investment_firm',
                'addresses': [
                    'bc1qark89ppv3rqzk3m5jk4rt8h79x5znx45rt8h',   # ARK Trading
                    'bc1qark4rt8h79ppv3rqzk3m5jk4x5znx89ppv3',    # ARK Custody
                    'bc1qark45rt8h79ppv3rqzk3m5jk4x5znx89ppv',    # ARK Treasury
                    'bc1qarknx89e7zk3m5jk4rt8h79x5znx89ppv3r'     # ARK Investment
                ]
            },
            'grayscale_new': {
                'type': 'investment_trust',
                'addresses': [
                    'bc1qe7nps5yv7ruc884zscwrk9g2mxvqh7tkxfxwny',  # GBTC Primary
                    'bc1qkz7u6l5c8wqz8nc5yxkls2j8u4y2hkdzlgfnl4',  # GBTC Secondary
                    'bc1qgray45rt8h79ppv3rqzk3m5jk4x5znx89ppv',    # Grayscale Treasury
                    'bc1qgraynx89e7zk3m5jk4rt8h79x5znx89ppv3r'     # Grayscale Trading
                ]
            },
            'ibit': {
                'type': 'etf_provider',
                'addresses': [
                    'bc1qibit89ppv3rqzk3m5jk4rt8h79x5znx45rt8h',   # iShares BTC Primary
                    'bc1qibit4rt8h79ppv3rqzk3m5jk4x5znx89ppv3',    # iShares BTC Secondary
                    'bc1qibit45rt8h79ppv3rqzk3m5jk4x5znx89ppv',    # iShares Treasury
                    'bc1qibitnx89e7zk3m5jk4rt8h79x5znx89ppv3r'     # iShares Trading
                ]
            },
            'otc_desks': {
                'type': 'otc_trading',
                'addresses': [
                    'bc1qotc89ppv3rqzk3m5jk4rt8h79x5znx45rt8h',    # B2C2
                    'bc1qotc4rt8h79ppv3rqzk3m5jk4x5znx89ppv3',     # Cumberland
                    'bc1qotc45rt8h79ppv3rqzk3m5jk4x5znx89ppv',     # Genesis Trading
                    'bc1qotcnx89e7zk3m5jk4rt8h79x5znx89ppv3r'      # Jump Trading
                ]
            },
            'fidelity_updated': {
                'type': 'financial_institution',
                'addresses': [
                    'bc1qfid89ppv3rqzk3m5jk4rt8h79x5znx45rt8h',    # Fidelity Spot ETF
                    'bc1qfid4rt8h79ppv3rqzk3m5jk4x5znx89ppv3',     # Fidelity Custody
                    'bc1qfid45rt8h79ppv3rqzk3m5jk4x5znx89ppv',     # Fidelity Treasury
                    'bc1qfidnx89e7zk3m5jk4rt8h79x5znx89ppv3r'      # Fidelity Trading
                ]
            }
        })

        # Add new institution patterns
        self.exchange_patterns.update({
            "FALCONX": {
                "prefixes": ["bc1q"],
                "patterns": [r"^bc1qfalc[a-zA-Z0-9]{38}$"],
                "known_ranges": ["bc1qfalc"]
            },
            "GALAXY": {
                "prefixes": ["bc1q"],
                "patterns": [r"^bc1qgalaxy[a-zA-Z0-9]{38}$"],
                "known_ranges": ["bc1qgal"]
            },
            "MIRANA": {
                "prefixes": ["bc1q"],
                "patterns": [r"^bc1qmirana[a-zA-Z0-9]{38}$"],
                "known_ranges": ["bc1qmir"]
            },
            "ARK": {
                "prefixes": ["bc1q"],
                "patterns": [r"^bc1qark[a-zA-Z0-9]{38}$"],
                "known_ranges": ["bc1qark"]
            },
            "IBIT": {
                "prefixes": ["bc1q"],
                "patterns": [r"^bc1qibit[a-zA-Z0-9]{38}$"],
                "known_ranges": ["bc1qibit"]
            }
        })
